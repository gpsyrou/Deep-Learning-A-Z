...
1) **Bank Customers**
    ...
    **Task 1 - Create the Artificial Neural Network**
    ...
    For this task we used an Artificial Neural  Network with 11 feautures and 1 output Layer. The final accuracy of the model was 86.25%, without any evaluation technique. 
